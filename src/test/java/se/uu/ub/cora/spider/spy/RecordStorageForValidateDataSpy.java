...
public class RecordStorageForValidateDataSpy implements RecordStorage {
	...
	public DataGroup read(String type, String id) {
		...
		// return DataGroup.withNameInData("place");
		// }

		// if ("abstract".equals(id)) {
		// return
		// DataCreator.createRecordTypeWithIdAndUserSuppliedIdAndAbstractAndPublicRead(id,
		// "false", "true", "false");
		// }
		...
		// }
		// if ("child2".equals(id)) {
		// return DataCreator.createRecordTypeWithIdAndUserSuppliedIdAndParentId(id,
		// "true",
		// "abstract");
		// }
		...
		// return
		// DataCreator.createRecordTypeWithIdAndUserSuppliedIdAndParentId("image",
		// "true",
		// "binary");
		//
		// }
		...
		// filter.addChild(DataAtomic.withNameInDataAndValue("linkedRecordType",
		// "metadataGroup"));
		// filter.addChild(
		...
		// return
		// DataCreator.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordId("image",
		...
		// .createRecordInfoWithIdAndTypeAndLinkedRecordId("book1", "book",
		// "testSystem")
		// .toDataGroup();
		...
		// DataGroup permissionRuleLink =
		// createPermissionRuleLink("ruleWithPermissionPart");
		// roleForGuest.addChild(permissionRuleLink);
		// return roleForGuest;
		// }
		// if ("permissionRole".equals(type) &&
		// "guestWithMultiplePermissionTerms".equals(id)) {
		// DataGroup roleForGuest = createRoleForGuest();
		// DataGroup permissionRuleLink =
		// createPermissionRuleLink("ruleWithPermissionPart");
		// roleForGuest.addChild(permissionRuleLink);
		...
		// permissionRole.addChild(DataAtomic.withNameInDataAndValue("activeStatus",
		// "inactive"));
		...
		//
		// DataGroup permissionRulePart = createPermissionRulePart("action",
		// "system.create",
		// "system.read");
		...
		// "ruleWithMultiplePermissionPart".equals(id)) {
		// DataGroup rule = DataGroup.withNameInData("permissionRule");
		//
		// DataGroup permissionRulePart = createPermissionRulePart("action",
		// "system.create",
