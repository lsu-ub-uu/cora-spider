...
public class SpiderRecordUpdaterTest {
	...
	public void testExternalDependenciesAreCalled() {
		...
		spiderDataGroup.addChild(
				SpiderDataCreator.createRecordInfoWithRecordTypeAndRecordId("spyType", "spyId"));
	...
	private SpiderDataGroup createRecordTypeDataGroupWithIdAndAbstract(String id, String abstractString) {
		...
		createRecordInfo.addChild(
				SpiderDataAtomic.withNameInDataAndValue("type", "recordType"));
		dataGroup.addChild(createRecordInfo);
