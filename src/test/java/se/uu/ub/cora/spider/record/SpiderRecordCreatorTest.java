...
public class SpiderRecordCreatorTest {
	...
	public void testAuthenticationNotAuthenticated() {
		...
		SpiderDataGroup spiderDataGroup = DataCreator
				.createRecordWithNameInDataAndLinkedRecordId("nameInData", "cora");
		recordCreator.createAndStoreRecord("dummyNonAuthenticatedToken", "spyType", spiderDataGroup);
	}
	...
	public void testAutogeneratedIdSentToStorageUsingGeneratedId() {
		...
		assertEquals(((RecordStorageCreateUpdateSpy) recordStorage).type, "typeWithAutoGeneratedId");
	...
	public void testCorrectRecordInfoInCreatedRecord() {
		...
		setUpDependencyProvider();
		SpiderDataGroup record = DataCreator
				.createRecordWithNameInDataAndIdAndLinkedRecordId("testingRecordInfo", "someId", "cora");

		SpiderDataRecord recordOut = recordCreator.createAndStoreRecord("someToken78678567", "spyType2",
				record);
		SpiderDataGroup groupOut = recordOut.getSpiderDataGroup();
		SpiderDataGroup recordInfo = groupOut.extractGroup("recordInfo");
		String recordId = recordInfo.extractAtomicValue("id");
	...
	public void testCreateRecordUnauthorized() {
		...
		SpiderDataGroup record = DataCreator.createRecordWithNameInDataAndLinkedRecordId("authority",
				"cora");
	...
	public void testUnauthorizedForCreateOnRecordTypeShouldShouldNotAccessStorage() {
		...
		assertEquals(extendedFunctionalityProvider.fetchedFunctionalityForCreateBeforeMetadataValidation
				.size(), 0);
	}
	...
	public void testCreateRecordDuplicateUserSuppliedId() {
		SpiderDataGroup record = DataCreator.createRecordWithNameInDataAndIdAndLinkedRecordId("place",
				"somePlace", "cora");
