...
import static se.uu.ub.cora.spider.testdata.DataCreator2.createLinkWithLinkedId;
...
public class RecordStorageCreateUpdateSpy implements RecordStorage {
	...
	public DataRecordGroup read(String type, String id) {
		...
		if (type.equals("recordType") && id.equals("typeWithAutoGeneratedId")) {
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"recordType", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "place", "placeNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "false", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
		...
		if (type.equals("recordType") && id.equals("typeWithUserGeneratedId")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"recordType", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "place", "placeNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		}
		if (type.equals("typeWithAutoGeneratedId") && id.equals("somePlace")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"typeWithAutoGeneratedId", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "place", "placeNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			group.addChild(new DataAtomicOldSpy("unit", "Uppsala"));
		...
		if (type.equals("typeWithUserGeneratedId") && id.equals("uppsalaRecord1")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"typeWithUserGeneratedId", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "place", "placeNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("unit", "Uppsala", record);
			return record;
		}
		if (type.equals("typeWithUserGeneratedId") && id.equals("gothenburgRecord1")) {
			...
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("unit", "gothenburg", record);
			return record;
		}
		if (type.equals("recordType") && id.equals("recordType")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"recordType", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "recordType", "recordTypeNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		}
		if (type.equals("recordType") && id.equals("image")) {
			...
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			DataRecordLink parent = createLinkWithLinkedId("parentId", "someType", "binary");
			DataCreator2.attachLinkToRecord(parent, record);
			return record;
		}
		if (id.equals("binary")) {
			// DataGroup group = new DataGroupOldSpy("recordType");
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"recordType", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "image", "imageNew");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "true", record);
			return record;
		}
		if (id.equals("metadataGroup")) {
			...
			// return group;
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "metadataGroupGroup", "metadataGroupNewGroup");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		}
		if (id.equals("metadataCollectionVariable")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "metadataCollectionVariableGroup",
					"metadataCollectionVariableNewGroup");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		...
		if (id.equals("metadataRecordLink")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "metadataRecordLinkGroup",
					"metadataRecordLinkNewGroup");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "true", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		...
		if (id.equals("typeWithAutoGeneratedIdWrongRecordInfo")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"recordType", id, type, "someDataDivider", "6789");
			addMetadataIdAndMetadataIdNew(record, "typeWithAutoGeneratedIdWrongRecordInfo",
					"typeWithAutoGeneratedIdWrongRecordInfoGroup");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("userSuppliedId", "false", record);
			DataCreator2.setAtomicNameInDataUsingValueInRecord("abstract", "false", record);
			return record;
		...
		if (id.equals("testGroup")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"testGroup", id, type, "someDataDivider", "6789");
			List<DataChild> refs = List.of(DataCreator2.createChildReference("childOne", "1", "1"));
			DataGroupSpy childReferences = DataCreator2.createChildReferences(refs);
		...
		if (id.equals("childOne")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("nameInData", "childOne", record);
			return record;
		}
		if (id.equals("childTwo")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("nameInData", "childTwo", record);
			return record;
		}
		...
		if (id.equals("testGroupWithOneChild")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"testGroupWithOneChild", id, type, "someDataDivider", "6789");
			List<DataChild> refs = List.of(DataCreator2.createChildReference("childOne", "1", "1"));
			DataGroupSpy childReferences = DataCreator2.createChildReferences(refs);
		...
		if (id.equals("testGroupWithTwoChildren")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"testGroupWithTwoChildren", id, type, "someDataDivider", "6789");
			List<DataChild> refs = List.of(DataCreator2.createChildReference("childOne", "1", "1"),
					DataCreator2.createChildReference("childWithSameNameInDataAsChildTwo", "0",
							"1"));
			DataGroupSpy childReferences = DataCreator2.createChildReferences(refs);
		...
		if (id.equals("testGroupWithThreeChildren")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
							"testGroupWithTwoChildren", id, type, "someDataDivider", "6789");
			List<DataChild> refs = List.of(DataCreator2.createChildReference("childOne", "1", "1"),
					DataCreator2.createChildReference("childTwo", "0", "1"),
					DataCreator2.createChildReference("childThree", "1", "1"));
			DataGroupSpy childReferences = DataCreator2.createChildReferences(refs);
		...
		if (id.equals("childThree")) {
			throw RecordNotFoundException.withMessage("No record exists with recordId: childThree");
		}
		...
		if (id.equals("testItemCollection")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataGroupSpy collectionItemReferences = DataCreator2
					.createGroupWithNameInData("collectionItemReferences");
			record.MRV.setSpecificReturnValuesSupplier("getFirstChildWithNameInData",
					() -> collectionItemReferences, "collectionItemReferences");

			DataRecordLinkSpy item1 = (DataRecordLinkSpy) createLinkWithLinkedId("ref", METADATA,
					"thisItem");
			DataCreator2.attachLinkToParent(item1, collectionItemReferences);
		...
		if (id.equals("testParentMissingItemCollectionVar")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataRecordLink refCollection = createLinkWithLinkedId("refCollection", METADATA,
					"testParentMissingItemCollection");
			DataCreator2.attachLinkToRecord(refCollection, record);
			return record;
		}
		...
		if (id.equals("thisItem")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("nameInData", "this", record);
			return record;
		}
		if (id.equals("thatItem")) {
			...
			DataRecordGroupSpy record = DataCreator2
					.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(METADATA,
							id, type, "someDataDivider", "6789");
			DataCreator2.setAtomicNameInDataUsingValueInRecord("nameInData", "that", record);
			return record;
		}
		if ("image".equals(type) && "image:123456789".equals(id)) {
			DataRecordGroup record = DataCreator2.createRecordWithNameInDataAndIdAndDataDivider(
					"image", "image:123456789", "cora");
			MCR.addReturned(record);
			return record;
		}
		// }
		...
		DataRecordGroupSpy record = DataCreator2
				.createRecordWithNameInDataAndIdAndTypeAndLinkedRecordIdAndCreatedBy(
						"someNameInData", id, type, "someDataDivider", "6789");
		record.MRV.setSpecificReturnValuesSupplier("getFirstAtomicValueWithNameInData",
				() -> "2016-10-01T00:00:00.000000Z", "tsCreated");
		return record;
	}
	...
	private void addMetadataIdAndMetadataIdNew(DataRecordGroupSpy group, String metadataId,
		...
		// TODO: switched new and not new :(
		DataRecordLink newId = createLinkWithLinkedId("newMetadataId", "metadataGroup", metadataId);
		DataCreator2.attachLinkToRecord(newId, group);
		DataRecordLink updateId = createLinkWithLinkedId("metadataId", "metadataGroup",
				metadataIdNew);
		DataCreator2.attachLinkToRecord(updateId, group);
	}
