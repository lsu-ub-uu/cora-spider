...
public class SpiderRecordUpdaterTest {
	...
	public void testUpdateRecord() {
		...
		createRecordInfo
				.addChild(SpiderDataAtomic.withDataIdAndValue("type", "typeWithAutoGeneratedId"));
	...
	@Test(expectedExceptions = DataException.class)
	public void testUpdateRecordIncomingDataIdsDoNotMatch() {
		RecordStorageCreateUpdateSpy recordStorage = new RecordStorageCreateUpdateSpy();
		SpiderRecordUpdater recordUpdater = SpiderRecordUpdaterImp
				.usingAuthorizationAndDataValidatorAndRecordStorageAndKeyCalculator(authorization,
						dataValidator, recordStorage, keyCalculator);
	...
	public void testUpdateRecordIncomingDataTypesDoNotMatch() {
		...
		SpiderDataGroup dataGroup = SpiderDataGroup
				.withDataId("typeWithUserGeneratedId_NOT_THE_SAME");
		SpiderDataGroup createRecordInfo = SpiderDataGroup.withDataId("recordInfo");
		createRecordInfo.addChild(SpiderDataAtomic.withDataIdAndValue("id", "place"));
		createRecordInfo.addChild(SpiderDataAtomic.withDataIdAndValue("type", "recordType"));
		dataGroup.addChild(createRecordInfo);
	...
	public void testUpdateRecordUserNotAuthorisedToStoreIncomingData() {
		...
		SpiderDataGroup dataGroup = SpiderDataGroup.withDataId("typeWithUserGeneratedId");
		SpiderDataGroup createRecordInfo = SpiderDataGroup.withDataId("recordInfo");
		createRecordInfo.addChild(SpiderDataAtomic.withDataIdAndValue("id", "uppsalaRecord1"));
		createRecordInfo
				.addChild(SpiderDataAtomic.withDataIdAndValue("type", "typeWithUserGeneratedId"));
		dataGroup.addChild(createRecordInfo);
		dataGroup.addChild(SpiderDataAtomic.withDataIdAndValue("unit", "gothenburg"));
	...
	public void testUpdateRecordUserNotAuthorisedToUpdateData() {
		...
		SpiderDataGroup dataGroup = SpiderDataGroup.withDataId("typeWithUserGeneratedId");
		SpiderDataGroup createRecordInfo = SpiderDataGroup.withDataId("recordInfo");
		createRecordInfo.addChild(SpiderDataAtomic.withDataIdAndValue("id", "gothenburgRecord1"));
		createRecordInfo
				.addChild(SpiderDataAtomic.withDataIdAndValue("type", "typeWithUserGeneratedId"));
		dataGroup.addChild(createRecordInfo);
		dataGroup.addChild(SpiderDataAtomic.withDataIdAndValue("unit", "uppsala"));
