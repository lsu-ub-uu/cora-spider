...
import se.uu.ub.cora.bookkeeper.termcollector.DataGroupTermCollectorFactoryImp;
...
public abstract class DependencyProviderAbstract implements SpiderDependencyProvider {
	...
	public DataGroupTermCollector getDataGroupTermCollector() {
		return new DataGroupTermCollectorFactoryImp().factor();
	}

	@Override
	public PermissionTermDataHandler getPermissionTermDataHandler() {
		return new PermissionTermDataHandlerImp();
	}
