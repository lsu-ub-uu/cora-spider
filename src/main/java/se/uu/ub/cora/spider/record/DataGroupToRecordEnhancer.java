...
public class DataGroupToRecordEnhancer {
	...
	public DataGroupToRecordEnhancer(SpiderDependencyProvider dependencyProvider, User user,
			String recordType, DataGroup dataGroup) {
	...
	public SpiderDataRecord enhance() {
