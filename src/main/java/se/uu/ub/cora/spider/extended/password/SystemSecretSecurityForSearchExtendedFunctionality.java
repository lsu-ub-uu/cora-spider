...
public class SystemSecretSecurityForSearchExtendedFunctionality implements ExtendedFunctionality {
	...
	private List<DataRecordLink> getListOfRecordTypesToSearchIn(ExtendedFunctionalityData data) {
		DataRecordGroup searchMetadataAsRecord = data.dataRecordGroup;
		return searchMetadataAsRecord.getChildrenOfTypeAndName(DataRecordLink.class,
