...
public final class SpiderRecordHandlerImp implements SpiderRecordHandler {
	...
	public SpiderDataRecord createAndStoreRecord(String userId, String recordType,
		...
		boolean incomingRecordHasRecordInfo = spiderDataGroup.containsChildWithDataId(RECORD_INFO);
		...
		if (shouldAutogenerateId) {
			if (incomingRecordHasRecordInfo) {
				throw new DataException(
						"RecordInfo should not be added to new records that have autogenerated ids");
			}
			...
			if (!incomingRecordHasRecordInfo) {
				throw new DataException(
						"RecordInfo should be added to new records that have user supplied ids");
			}
